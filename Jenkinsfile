        ...
        stage('Initialize environment') {
            ...
            steps {
                script {
                    ...
                    env.IMAGE_NAME = 'postsmith-hub.kr.ncr.ntruss.com/postsmith-api-content'
        ...
        stage('Deploy K8s') {
            ...
            steps {
                script {
                    ...
                    k8s.deploy("postsmith-api-content-app-deploy", "postsmith-api-content-app", "postsmith-deploy", env.IMAGE_NAME, env.IMAGE_TAG)
